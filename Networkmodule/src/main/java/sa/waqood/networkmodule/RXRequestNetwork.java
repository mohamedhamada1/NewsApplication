...
public class RXRequestNetwork {
    ...
    public static RXUploadRequestCreator upload(String requestUrl) {
        return new RXUploadRequestCreator(requestUrl);

    }

    public static RXUploadRequestCreator upload(String requestUrl, HashMap<String, String> header) {
        return new RXUploadRequestCreator(requestUrl, header);
    }

    public static RXUploadRequestCreator upload(String requestUrl, HashMap<String, String> header, String contentType) {
        return new RXUploadRequestCreator(requestUrl, header, contentType);
    }
